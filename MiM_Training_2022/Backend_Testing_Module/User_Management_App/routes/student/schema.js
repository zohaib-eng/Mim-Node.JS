...
const SupplierSchema = new Schema({
  ...
  const dispute=mongoose.model("HelpDispute",disputeSchema)
...
const easymodel= mongoose.model("easypasa",easySchema);


  module.exports = { Impact:Impact,User:User,Payment:Payment,Supp:Supp,Station:Station,dispute:dispute,easymodel:easymodel};